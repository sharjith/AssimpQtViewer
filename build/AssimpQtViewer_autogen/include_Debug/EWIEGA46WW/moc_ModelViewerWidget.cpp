...
namespace {
struct qt_meta_tag_ZN17ModelViewerWidgetE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN17ModelViewerWidgetE = QtMocHelpers::stringData(
    "ModelViewerWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17ModelViewerWidgetE[] = {
...
Q_CONSTINIT const QMetaObject ModelViewerWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17ModelViewerWidgetE.offsetsAndSizes,
    qt_meta_data_ZN17ModelViewerWidgetE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17ModelViewerWidgetE_t,
        // Q_OBJECT / Q_GADGET
...
void *ModelViewerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17ModelViewerWidgetE.stringdata0))
